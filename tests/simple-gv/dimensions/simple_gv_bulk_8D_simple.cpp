...
int main(int argc, char *argv[])
{
    ...
    { 
        ...
        pgrid[0] = 0; pgrid[1] = 0; pgrid[2] = 0; pgrid[3] = 0; pgrid[4] = 0; pgrid[5] = 0; pgrid[6] = 0; pgrid[7] = 0;
    }
    else // process #1
    {
        dims[0] = 2; dims[1] = 2; dims[2] = 2; dims[3] = 2; dims[4] = 2; dims[5] = 2; dims[6] = 2; dims[7] = 2;
        pgrid[0] = 0; pgrid[1] = 1; pgrid[2] = 0; pgrid[3] = 0; pgrid[4] = 0; pgrid[5] = 0; pgrid[6] = 0; pgrid[7] = 0;
    }
