...
#ifdef USE_MPI_RMA
void gacc(FILE * output, int max_iters, MPI_Comm comm, MPI_Win win)
#else
void gacc(FILE * output, int max_iters, MPI_Comm comm, rmacxx::Window<char>& win)
#endif
{
...
#else
        win(target, {0}, {0}, REPLACE, &val) >> &result;
#endif
    }
...
int main(int argc, char * argv[])
{
    ...
    gacc(stdout, max_iters, MPI_COMM_WORLD, win);
